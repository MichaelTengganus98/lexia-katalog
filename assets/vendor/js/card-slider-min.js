  ...
  !(function(i) {
    ...
    i.fn.cardSlider = function(s) {
      ...
      return (
        ...
        (this.init = function() {
          (this.transitionEvent = n.whichTransitionEvent()),
            this.setSlides(),
        ...
        (this.setSlides = function() {
          this.params.slideClass
            ? (this.slides = this.slider.find(
                this.params.slideTag + "." + this.params.slideClass
              ))
        ...
        (this.resetSlideClasses = function() {
          this.slides
            .removeClass(
              "left-hidden-slide left-slide center-slide right-slide right-hidden-slide"
            )
        ...
        (this.moveHandler = function() {
          if (
            (n.setSlideClasses(),
            n.hasFunction(n.params.onMove)
              ? n.callFunction(n.params.onMove, n.afterMoveHandler)
              : n.afterMoveHandler(),
            n.hasFunction(n.params.onAfterTransition))
          ) {
        ...
        (this.move = function() {
          0 == this.current
            ...
            : this.current > this.count && (this.current = 1),
            this.hasFunction(this.params.onBeforeMove)
        ...
        (this.followContent = function() {
          if (this.params.followingClass) {
            ...
            if (t) {
              var s = t.data("index");
              i(
                "." + this.params.followingClass + '[data-index="' + s + '"]'
              ).show();
            }
          }
        }),
        ...
        (this.whichTransitionEvent = function() {
          var i,
            t = document.createElement("transitionCheckElement"),
            s = {
